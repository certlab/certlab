    ...
    return (
      <div className="space-y-1">
        ...
        >
          ...
          <div
            className={`w-6 h-6 rounded-md ${getNodeColor(node.type)} flex items-center justify-center text-white`}
          >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Explore the Cert Lab application routes, components, and dependencies through an
            ...
            <Card>
              <CardContent className="pt-6 text-center">
                <p className="text-muted-foreground">
                  No UI structure data available. The dynamic sync may be initializing.
                </p>
                <p className="text-xs text-muted-foreground mt-2">
                  Debug: structureData={structureData ? 'loaded' : 'null'}, routes=
                    ...
                    <ScrollArea className="h-[600px] px-4 pb-4">
                      <div className="space-y-1">
                        {filteredRoutes.length > 0 ? (
                          filteredRoutes.map((route) => <TreeNode key={route.id} node={route} />)
                        ) : routeHierarchy.length === 0 ? (
                          <div className="text-center py-8 text-muted-foreground">
                            <div className="text-sm">No routes loaded yet...</div>
                            <div className="text-xs mt-1">
                              Data syncing: {structureData ? 'Complete' : 'In progress'}
                            </div>
                          </div>
                        ) : (
                          <div className="text-center py-8 text-muted-foreground">
                ...
                {selectedNode ? (
                    ...
                    <Card>
                      <CardHeader>
                        <div className="flex items-center space-x-4">
                          <div
                            className={`w-12 h-12 rounded-lg ${getNodeColor(selectedNode.type)} flex items-center justify-center text-white`}
                          >
                            ...
                            {selectedNode.children.map((child) => (
                              ...
                              >
                                <div className="flex items-start space-x-3">
                                  <div
                                    className={`w-8 h-8 rounded-md ${getNodeColor(child.type)} flex items-center justify-center text-white flex-shrink-0`}
                                  >
                      ...
                      selectedNode.type === 'component' && (
                        <Card>
                          <CardContent className="pt-6 text-center">
                            ...
                            <p className="text-muted-foreground">
                              This is a leaf component with no child components. Check the
                              dependencies above to understand its integrations.
                            </p>
                          </CardContent>
                        </Card>
                      )}
                  ...
                  <Card>
                    <CardContent className="pt-6 text-center">
                      ...
                      <p className="text-muted-foreground">
                        Choose a route from the navigation tree to explore its components and
                        dependencies.
                      </p>
                    </CardContent>
                  </Card>
