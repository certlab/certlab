...
export function createInsertQuestion(overrides?: Partial<InsertQuestion>): InsertQuestion {
  return {
    ...
    acceptedAnswers: overrides?.acceptedAnswers || undefined,
    matchingPairs: overrides?.matchingPairs || undefined,
    orderingItems: overrides?.orderingItems || undefined,
    ...
    explanationSteps: overrides?.explanationSteps || undefined,
    referenceLinks: overrides?.referenceLinks || undefined,
    videoUrl: overrides?.videoUrl || undefined,
    communityExplanations: overrides?.communityExplanations || undefined,
  };
}
