...
export default function WeeklyProgress() {
  ...
  // Restrict entire WeeklyProgress component for Pro/Enterprise users
  if (!analyticsFeatures.performanceTrends) {
    return (
      <Card className="h-full bg-card border-border/50">
        ...
        <CardContent>
          <LockedAnalytics title="Weekly Progress Tracking" requiredLevel="advanced">
