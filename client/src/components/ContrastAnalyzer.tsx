      ...
      <CardContent className="space-y-4">
            ...
            <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right">
                  <div className="text-sm font-mono">{item.result.ratio}:1</div>
                  <div className="text-xs text-muted-foreground">Min: 4.5:1</div>
                </div>
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-muted-foreground space-y-1">
            <div>
              • <strong>AA Standard:</strong> 4.5:1 contrast ratio (minimum for most content)
            </div>
            <div>
              • <strong>AAA Standard:</strong> 7:1 contrast ratio (enhanced accessibility)
            </div>
            <div>
              • <strong>Large Text:</strong> 3:1 minimum (18pt+ or 14pt+ bold)
            </div>
          </div>
        </div>

        <Button onClick={analyzeContrast} variant="outline" size="sm" className="w-full">
